"""
FleetGuard Document Interpretation - Tyre Invoice
"""
...
class TyreInvoiceInterpreter(BaseDocumentInterpreter):
    @classmethod
    def key(cls) -> str:
        return "tyre_invoice_interpreter"

    @classmethod
    def get_business_type(cls) -> BusinessDocumentType:
        return BusinessDocumentType.TYRE_INVOICE
