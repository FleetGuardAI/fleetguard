...
class EntityBaseline(Base):
    ...
    entity_type: Mapped[EntityTypeEnum] = mapped_column(Enum(EntityTypeEnum, name="baseline_entity_type"), nullable=False, index=True)
    metric_type: Mapped[FuelMetricType] = mapped_column(Enum(FuelMetricType, name="baseline_fuel_metric_type"), nullable=False, index=True)
    ...
    data_quality: Mapped[DataQuality] = mapped_column(Enum(DataQuality, name="baseline_data_quality"), nullable=False)
    
    status: Mapped[BaselineStatus] = mapped_column(Enum(BaselineStatus, name="baseline_status"), nullable=False, default=BaselineStatus.VALID)
    ...
    __table_args__ = (
        UniqueConstraint("entity_id", "entity_type", "metric_type", "period_start", "period_end", name="uix_entity_baseline_period"),
