"""
Tyre Intelligence - Tyre Health Decision Engine
"""
...
class TyreHealthDecisionEngine(BaseDecisionEngine):
    """
    Consumes the Tyre Health Risk Profile and produces a final business recommendation.
    """

    @classmethod
    def key(cls) -> str:
        return "tyre.health_decision"

    @classmethod
    def name(cls) -> str:
        return "Tyre Health Decision Policy"
    ...
    def execute(self, profiles: List[DomainRiskProfile]) -> Recommendation:
        ...
        if req_key not in profile_dict:
            return Recommendation(
                ...
                recommendation=None,
                summary="Missing required tyre health risk profile.",
        ...
        if profile.status == DomainRiskStatus.ERROR:
            return Recommendation(
                ...
                recommendation=None,
                summary="Tyre health risk engine encountered an error.",
                supporting_profiles=profiles
            )
        ...
        if profile.status == DomainRiskStatus.INCONCLUSIVE:
            return Recommendation(
                ...
                status=DecisionStatus.INCONCLUSIVE,
                recommendation=None,
                summary="Tyre health risk was inconclusive.",
                supporting_profiles=profiles
            )
        ...
        if profile.risk_level == RiskLevel.LOW:
            return Recommendation(
                ...
                summary="Tyre condition is safe. Approved for operation.",
                supporting_profiles=profiles
            )
            ...
            return Recommendation(
                ...
                summary="Minor tyre issues detected. Schedule review.",
                supporting_profiles=profiles
            )
            ...
            return Recommendation(
                ...
                summary="Multiple tyre issues detected. Immediate review required.",
                supporting_profiles=profiles
            )
        else: # CRITICAL
            return Recommendation(
                ...
                summary="Critical tyre safety condition detected. Vehicle grounded (Rejected).",
                supporting_profiles=profiles
            )
